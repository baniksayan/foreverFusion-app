...
class Product
{
    ...
    public function add_product()
    {
        ...
        $this->price_of_the_product = trim(htmlspecialchars(strip_tags($this->price_of_the_product)));
        $this->description = trim(htmlspecialchars(strip_tags($this->description)));
        
        $sql = "INSERT INTO $this->table (seller_id, name, image, price_of_the_product, description) VALUES (
            '" .$database->escape_value($this->seller_id). "',
            '" .$database->escape_value($this->name). "',
            '" .$database->escape_value($this->image). "',
            '" .$database->escape_value($this->price_of_the_product). "',
