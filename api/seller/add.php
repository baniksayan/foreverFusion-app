...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($product->validate_params($_POST['price_of_the_product'])) {
        $product->price_of_the_product = $_POST['price_of_the_product'];
    } else {
        echo json_encode(array('success' => 0, 'message' => 'Price of the product is required!'));
        die();
    }
